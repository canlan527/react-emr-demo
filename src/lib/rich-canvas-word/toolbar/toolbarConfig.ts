...
export const richToolbarItems: ToolbarItem[] = [
  ...
  { id: 'export-json', type: 'button', command: 'exportJson', label: 'JSON' },
  { id: 'export-text', type: 'button', command: 'exportPlainText', label: 'TXT' },
  { id: 'print-preview', type: 'button', command: 'printPreview', label: 'Print' },
  { id: 'export-pdf', type: 'button', command: 'exportPdf', label: 'PDF' },
  { id: 'sep-export', type: 'separator' },
  { id: 'copy', type: 'button', command: 'copy', label: 'Copy' },
